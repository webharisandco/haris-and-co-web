  ...
  return (
    <div className="px-[16px] fixed z-50 md:px-[80px] py-[35px] w-full bg-[#fff]  flex justify-between items-center">
      ...
      <div className='items-center gap-[25px] xl:gap-[49px] hidden lg:flex'>
        <div className="flex tracking-wide justify-between gap-[25px] xl:gap-[40px] 3xl:gap-[55px]   text-black text-sm 2xl:text-base  *:text-nowrap  ">
          <Link to="/" className={`${location.pathname === "/" ? "font-medium" : " font-[thin] "}  `}>Home</Link>
          <Link to="/services" className={` ${location.pathname === "/services" ? "font-medium" : " font-[thin] "} `}>Services</Link>
          <Link to="/works" className={`${location.pathname === "/works" ? "font-medium" : "font-[thin]"} `}>Works</Link>
          {/* <Link to="/clients" className={`${location.pathname === "/clients" ? "font-medium" : "font-[thin]"} `}>Clients</Link> */}
          <Link to="/awards" className={`${location.pathname === "/awards" ? "font-medium" : "font-[thin]"} `}>Awards</Link>
          <Link to="/about" className={`${location.pathname === "/about" ? "font-medium" : "font-[thin]"} `}>Our Story </Link>
          <Link to="/blogs" className={`${location.pathname === "/blogs" ? "font-medium" : "font-[thin]"} `}>Blogs</Link>
          <Link to="/career" className={`${location.pathname === "/career" ? "font-medium" : "font-[thin]"} `}>Careers</Link>
        </div>
