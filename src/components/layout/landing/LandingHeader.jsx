...
const LandingHeader = () => {
    ...
    return (
        <header className='flex justify-between bg-black px-[18px] py-[40px] md:px-[80px] lg:px-[100px] md:py-[40px] items-center border-b border-b-white/50'>
            ...
            <div className={"hidden md:flex justify-between items-center gap-[30px] xl:gap-[40px] text-white/80 *:font-light  "}>
            ...
            <LandingButton text={'GET A PROPOSAL'} className={'hidden md:flex '} />
