    ...
    const InnerContent = (
        <div className="px-[22px] py-[12px] flex items-center gap-[10px] border border-solid border-white group-hover:bg-white group-hover:ps-[20px] group-hover:pr-[20px] group-hover:text-black w-[175px]">
            ...
            <div>
                ...
                />
                <RightArrow className="opacity-0 transition-all duration-300 delay-200 ease-out group-hover:opacity-100 absolute group-hover:relative group-hover:-translate-x-2" />
            </div>
        </div>
    );
