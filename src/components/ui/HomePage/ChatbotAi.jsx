...
//   // Detect light or dark background mode
...
//       className={`fixed right-4 bottom-8 rounded-full w-14 h-14 flex items-center justify-center shadow-lg transition-all duration-300 z-50
//         ${
//           isDarkMode
...
const Chatbot = () => {
  ...
  return (
    <a
      ...
      rel="noopener noreferrer"
      aria-label="Chat on WhatsApp"
      className="fixed right-4 bottom-8 
                 bg-black text-white 
