    ...
    return (
        <div class="relative w-full">
            <input
                type="text"
                id="floatingInput"
                class="peer w-full border-0 border-b border-white/60 bg-transparent text-white/60 placeholder-transparent focus:border-white focus:outline-none focus:ring-0 p-2"
                placeholder=" "
            />
            <label
                for="floatingInput"
