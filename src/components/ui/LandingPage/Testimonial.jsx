      ...
      >
        {testimonials.map((data) => (
          <SwiperSlide key={data.id}>
            <div className="shadow-[0px_0px_6.63px_6.63px_#1515150D] px-[16px] md:px-[80px] lg:px-[100px] py-[50px] grid lg:grid-cols-[1fr_2fr] items-center gap-[30px] min-h-[750px] md:min-h-[632px] lg:min-h-[500px]">
