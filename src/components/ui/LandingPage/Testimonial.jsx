        ...
        <div className="py-[50px]">
            <div className="shadow-[0px_0px_6.63px_6.63px_#1515150D] px-[16px] md:px-[80px] lg:px-[100px] py-[50px] grid lg:grid-cols-[1fr_1.2fr] items-center gap-10">
                ...
                <div className="relative">
                    <div
                        className="bg-[#151515] rounded-[24px] lg:rounded-[40px] min-h-[300px] lg:min-h-[400px] w-full"
                    >
                        <div className={`absolute inset-0 p-5 lg:px-[45px] lg:pb-[40px] lg:pt-[65px] text-white flex flex-col gap-4 text-[13px] lg:text-lg transition-opacity ease-in-out duration-500 ${
                            ...
                            <div className="flex gap-3 lg:gap-5 items-center text-[15px] mt-auto">
                                <img
