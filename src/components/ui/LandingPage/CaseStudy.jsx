...
import WImg1 from '@/assets/images/landing/case-study/w-img1.svg'
import WImg2 from '@/assets/images/landing/case-study/w-img2.svg'
import WImg3 from '@/assets/images/landing/case-study/w-img3.svg'
...
const CaseStudy = ({web}) => {
    return (
        <div className='px-[16px] md:px-[80px] lg:px-[100px] py-[50px]'>
            ...
            {!web ? <div className="flex flex-col lg:flex-row gap-5 poppins-regular">
            ...
            </div> : <div className="flex flex-col lg:flex-row gap-5 poppins-regular">
                <div className="shadow-[6.91px_6.91px_20.74px_0px_#00000026] px-4 py-3 rounded-3xl lg:w-1/2 space-y-9">
