            ...
            <div className="flex flex-col lg:flex-row gap-5 poppins-regular">
                <div className="shadow-[6.91px_6.91px_20.74px_0px_#00000026] px-4 py-3 rounded-3xl lg:w-1/2 space-y-9">
                    ...
                    <div className="flex flex-col gap-3 md:gap-5 lg:gap-7 px-2 lg:px-5">
                        ...
                        <p className='text-base lg:text-xl w-11/12 lg:w-10/12 mb-4 text-[#929090]'>Explore how we transformed Bluetyga into a revenue-generating company from scratch.</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col lg:w-1/2 gap-7">
                    <div className="shadow-[6.91px_6.91px_20.74px_0px_#00000026] px-2 md:px-4 py-4 rounded-3xl grid lg:grid-cols-[1fr_1.1fr] gap-10">
                        ...
                        <div className=" flex flex-col gap-3 md:gap-5 justify-center px-2 lg:pr-5 ">
                            ...
                            <div className="flex gap-3 text-base lg:text-xl items-center"><Clock color='#fff' fill='#888888' /><p className='text-[#929090]'>March 8, 2024</p></div>
                            <p className='text-base lg:text-xl text-[#929090] mt-5'>Dive in to learn how we improved the online sales rate of Walkaroo - one of India's leading footwear brands.
                            </p>
                        </div>
                    </div>
                    <div className="shadow-[6.91px_6.91px_20.74px_0px_#00000026] px-4 py-3 rounded-3xl hidden lg:grid grid-cols-[1fr_1.1fr] gap-10">
                        ...
                        <div className="flex flex-col gap-7 justify-center ">
                            ...
                            <div className="flex gap-3 text-base lg:text-xl items-center"><Clock color='#fff' fill='#888888' /><p className='text-[#929090]'>March 8, 2024</p></div>
                            <p className='text-base lg:text-xl text-[#929090]'>Explore how we transformed Bluetyga into a revenue-generating company from scratch.</p>
                        </div>
                    </div>
                </div>
            </div>
