...
function ContactSection({ kerala, address }) {
  ...
  return (
    <div id="callback-desktop" className="pt-[68px] md:pt-[160px] -mt-[90px] bg-white relative ">
      <div className="px-[16px] md:px-[80px] lg:px-[100px] flex flex-col justify-between md:relative z-10 static  bg-[#151515]">
        ...
        <div id="callback-mobile" className="w-auto block lg:hidden poppins-medium">
      ...
      <div className="relative w-full  z-0 *:w-full">
        ...
        {kerala ? (
          <iframe
            title="Haris & Co Kerala Location"
