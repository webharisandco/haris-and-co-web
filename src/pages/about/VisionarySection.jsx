...
export default function VisionarySection() {
    return (
        <div className='bg-[#0E0E0E] text-white flex flex-col items-center py-[50px] lg:py-[80px] px-[16px] md:px-[80px] gap-[120px]  lg:gap-[80px] xl:gap-[100px] '>
            ...
            <div className="flex flex-col lg:flex-row gap-20">
                <div className="lg:w-1/2 bg-[#212121] flex flex-col md:flex-row h-[550px] md:h-[500px] lg:h-[320px] 3xl:h-[450px] relative">
                    <div className="md:w-7/12  h-1/2 md:h-full relative">
                        <img src={humanprenuerImg} alt="" className='absolute w-full lg:w-auto bottom-[50%] md:bottom-[0]  lg:h-[500px]  xl:h-[550px] 3xl:h-[650px]  3xl:w-full object-cover  md:-left-2 ' />
                    </div>
