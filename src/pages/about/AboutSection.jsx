...
export default function AboutSection() {
    return (
        <div className='bg-white px-[80px] pt-[50px] -mb-[70px] space-y-10 '>
            <img src={BannerImg} alt="" className='-translate-y-36' />
            <div className=" flex lg:gap-12 xl:gap:14 -translate-y-36">
                <h2 className='font-medium w-1/2  lg:text-[27px]  xl:text-[29px] 3xl:text-[40px]'>
                    About Haris&Co.: Where Creativity Meets Strategy, Transforming Brands
                </h2>
                <div className=" w-1/2 space-y-5 text-[15px] font-[Helvetica-Light] text-black/80">
