...
export default function UIPerformance() {
  ...
  const faqList = [
    {
      ...
      answer:
        "Performance marketing is ideal for businesses of all sizes and industries looking for measurable, results-driven campaigns. Whether in e-commerce, B2B, services, or tech, performance marketing can help you drive traffic, generate leads, and increase sales.Working with a Performance Marketing Agency in Sharjah. can help tailor campaigns to your specific goals, ensuring maximum ROI and efficiency across all digital channels.",
    },
    {
      question:
        "What is the typical budget for a performance marketing campaign?",
      answer:
        "The budget for a performance marketing campaign depends on your goals, industry, and target audience. We work with businesses of all sizes and create customised plans that maximise your return on investment. Whether you have a small or large budget, we’ll optimise your campaigns to get the best results.",
    },
    {
      question: "How do I get started with performance marketing?",
      answer:
        "Getting started is easy! Simply reach out to our team for a consultation. We'll discuss your goals, understand your target audience, and craft a tailored performance marketing strategy that fits your business needs and budget.",
    },
    {
      question:
        "What makes Haris&Co’s performance marketing services different from others?",
      answer:
        "At Haris & Co's performance marketing agency in Sharjah, we focus on data-driven results and continuous optimisation. We don’t just run ads - we strategically manage and fine-tune every aspect of your campaigns to ensure maximum ROI. Our approach is transparent, collaborative, and tailored to your business goals.",
    },
    {
      question:
        "Can performance marketing work for both B2B and B2C companies?",
      answer:
  ...
  const aboutHeading = "We Deliver Ads That Deliver Sales";
  const aboutDescription =
    "At Haris&Co., our performance marketing team in Sharjah transforms raw data into strategies that boost your bottom line. From planning and developing creatives to campaign execution & optimisation, we do everything. With us, you can rest assured that the creatives will have the quality to convey your message and the ads will be displayed to the exact audience, ensuring you get the best results without overspending. We also have experience in being the growth partner of 10+ emerging brands, helping them scale from scratch.";
  const tagline = "Expert Performance Marketing Agency in Sharjah";
  return (
    <div className="bg-black">
      <Helmet>
        <title>Expert Performance Marketing Agency in Sharjah</title>
      </Helmet>
      <meta
        name="description"
        content="An award-winning performance marketing agency in Sharjah that focuses on high-quality lead generation and boosting sales to the next level."
      />
      <link
        rel="canonical"
        href="https://harisand.co/ae/services/performance-marketing-agency-in-sharjah"
      />
      <meta
        property="og:title"
        content="Expert Performance Marketing Agency in Sharjah"
      />
      <meta
        ...
        <div className="px-[16px] md:px-[60px] lg:px-[100px] py-[40px] flex flex-col gap-14">
          <div className="flex flex-col gap-6">
            ...
            <p className="poppins-regular text-[11px] md:text-[15px] lg:text-[14px]  2xl:text-[17px]">
              ...
              models, where you pay upfront for exposure (e.g., impressions or
              views), performance marketing is focused on measurable outcomes.
              This model ensures that your advertising spend is tied directly to
              the success of your campaign, providing a more result-driven and
              cost-effective approach to achieving business goals. Working with
              a Performance Marketing Agency in Sharjah like Haris&Co. allows
              you to take advantage of this results-driven approach. They help
              you set clear goals, track outcomes, and continuously optimise
              your campaigns to ensure that every penny spent is delivering
              value.
            </p>
          </div>
          {!isExpanded ? (
                  ...
                  <ul type="dot" className="list-disc ps-5	gap-5 grid">
                    <li>
                      ...
                      <span className="poppins-regular">
                        ...
                        results. With a Performance Marketing Agency in Sharjah
