...
export default function UIWeb() {
  ...
  const webDevelopmentServices = [
    ...
    },
    {
      ...
      description:
        "We don't just build websites. We are a web development company in Sharjah that creates digital assets that drive business growth through strategic design and conversion optimization.",
    },
    {
