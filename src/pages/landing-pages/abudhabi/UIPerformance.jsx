...
export default function UIPerformance() {
  ...
  return (
    <div className="bg-black">
      ...
      <meta
        name="description"
        content="An award-winning performance marketing agency in Abu Dhabi that focuses on high-quality lead generation and boosting sales to the next level."
      />
      <link
        rel="canonical"
        href="https://harisand.co/ae/services/performance-marketing-agency-in-abudhabi"
      />
      <meta
        property="og:title"
        content="Expert Performance Marketing Agency in Abu Dhabi"
      />
      <meta
        ...
        <div className="px-[16px] md:px-[60px] lg:px-[100px] py-[40px] flex flex-col gap-14">
          <div className="flex flex-col gap-6">
            ...
            <p className="poppins-regular text-[11px] md:text-[15px] lg:text-lg">
              ...
              a Performance Marketing Agency in Abu Dhabi like Haris&Co. allows
