...
export default function UIWeb() {
  ...
  const webDevelopmentServices = [
    ...
    },
    {
      ...
      description:
        "We don't just build websites. We are a web development company in Abu Dhabi that creates digital assets that drive business growth through strategic design and conversion optimisation.",
    },
    {
