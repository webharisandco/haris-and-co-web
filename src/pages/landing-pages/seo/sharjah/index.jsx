...
function Sharjah() {
  const faqs = [
    ...
    {
      question:
        "Why should I hire an SEO agency in Sharjah? Can’t I do it myself?",
      answer:
  ...
  const seoDescription =
    "As a result-oriented SEO agency in Sharjah, we help you rise to the forefront of the search results and bring more sales-qualified visitors to your website. The best part is that we have dedicated experts for everything SEO.";
  const smlHeading = "A Rapidly Growing SEO Company in Sharjah";
  ...
  const contentData = [
    {
      heading: "An SEO Company in Sharjah That Focus on Boosting Revenue",
      headingClass: "text-3xl",
      paragraphs: [
        "Ranks and traffic are good but what matters the most is generating leads and boosting revenue.",
        "As an ROI-focused SEO agency in Sharjah, we formulate strategies based on your specific audience and industry. We combine in-depth keyword research, strategic on-page optimisation, well-thought-out content strategy and effective link building to get your website noticed by the right people.",
        ...
        "Stop waiting for customers to find you. Get our best SEO services in Sharjah and generate leads.",
      ],
    },
    {
      ...
      listItems: [
        ...
        },
        {
          type: "text",
          content:
            "Boost website traffic: As an SEO company in Sharjah, we help your website rank higher in search results, meaning more people will find you naturally.",
        },
        {
          type: "text",
          content:
    ...
    {
      heading: "A Streamlined SEO Company in Sharjah",
      headingClass: "text-2xl",
      listItems: [
        {
          type: "subSection",
          ...
          locations: [
            ...
            },
            {
              ...
              url: "/ae/services/seo-company-in-dubai",
            },
            {
  ...
  return (
    <div>
      ...
      <meta
        name="description"
        content="We are an SEO company in Sharjah that prioritises lead generation over ranks, and website visitors."
        data-rh="true"
      />
      <link
        rel="canonical"
      ...
      <meta
        property="og:title"
        content=" ROI-focused SEO Company in Sharjah | Haris&Co"
      />
      <meta
