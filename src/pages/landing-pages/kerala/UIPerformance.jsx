...
export default function UIPerformance() {
  ...
  const aboutDescription =
    "At Haris&Co., our performance marketing team in Kerala transforms raw data into strategies that boost your bottom line. From planning and developing creatives to campaign execution & optimisation, we do everything. With us, you can rest assured that the creatives will have the quality to convey your message and the ads will be displayed to the exact audience, ensuring you get the best results without overspending. We also have experience in being the growth partner of 10+ emerging brands, helping them scale from scratch.";
  const tagline = "Expert Performance Marketing Agency in Kerala";
  return (
    <div className="bg-black">
      <Helmet>
        <title>Expert Performance Marketing Agency in Kerala</title>
      </Helmet>
      <meta
        name="description"
        content="An award-winning performance marketing agency in Kerala that focuses on high-quality lead generation and boosting sales to the next level."
      />
      <link
        rel="canonical"
        href="https://harisand.co/services/performance-marketing-agency-in-kerala"
      />
      <meta
        property="og:title"
        content="Expert Performance Marketing Agency in Kerala"
      />
      <meta
        ...
        <div className="px-[16px] md:px-[60px] lg:px-[100px] py-[40px] flex flex-col gap-14">
          <div className="flex flex-col gap-6">
            ...
            <p className="poppins-regular text-[11px] md:text-[15px] lg:text-lg">
              ...
              a Performance Marketing Agency in Kerala like Haris&Co. allows you
              to take advantage of this results-driven approach. They help you
              set clear goals, track outcomes, and continuously optimise your
              ...
              <ul type="dot" className="list-disc ps-5	gap-5 grid">
                <li>
                  ...
                  <span className="poppins-regular">
                    ...
                    results. With a Performance Marketing Agency in Kerala like
                  ...
                  <>
                    <li>
                      ...
                      <span className="poppins-regular">
                        ...
                        Kerala like Haris&Co., you can ensure that your
                    ...
                    <li>
                      ...
                      <span className="poppins-regular">
                        ...
                        Marketing Agency in Kerala like Haris&Co. leverages
