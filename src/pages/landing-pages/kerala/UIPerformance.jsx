...
export default function UIPerformance() {
  ...
  return (
    <div className='bg-black'>
      ...
      <meta name="description" content="An award-winning performance marketing agency in Kerala that focuses on high-quality lead generation and boosting sales to the next level." />
      <link rel="canonical" href="https://harisand.co/services/performance-marketing-agency-in-kerala" />
      <meta property="og:title" content="Expert Performance Marketing Agency in Kerala" />
      <meta property="og:description" content="An award-winning performance marketing agency in Kerala that focuses on high-quality lead generation and boosting sales to the next level." />
      <LandingHeader />
      <div className="">
        <Banner
        ...
        <div className="px-[16px] md:px-[60px] lg:px-[100px] py-[40px] flex flex-col gap-14">
          <div className="flex flex-col gap-6">
            ...
            <p className='poppins-regular text-[11px] md:text-[15px] lg:text-lg'>Performance marketing is a digital marketing strategy where you pay only for the results you get - whether that’s a click, lead, sale, or other desired action. Unlike traditional advertising models, where you pay upfront for exposure (e.g., impressions or views), performance marketing is focused on measurable outcomes. This model ensures that your advertising spend is tied directly to the success of your campaign, providing a more result-driven and cost-effective approach to achieving business goals.
              Working with a Performance Marketing Agency in Kerala  like Haris&Co. allows you to take advantage of this results-driven approach. They help you set clear goals, track outcomes, and continuously optimise your campaigns to ensure that every penny spent is delivering value.
            </p>
          </div>
          <div className="flex flex-col gap-6">
