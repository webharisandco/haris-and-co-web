...
function Dubai() {
 ...
 const faqList = [
  {
    question: "Do you provide digital marketing for D2C businesses in Dubai, UAE?",
    answer:
  ...
  return (
    <div>
   	<Helmet>
					<title>ROI-focused Digital Marketing Agency in Dubai, UAE | Haris&Co</title>
					...
					<link rel="preload" as="image" href={founder} fetchPriority='high' />
					<link rel="preload" as="image" href={aw2} />
					<link rel="preload" as="image" href={aw3} />
				</Helmet>
      ...
      <div className="mt-[120px]">
        <ContactSection address={"Abdulla Kamber Business Center, Room No 103, First Floor, Abu Baker Al Siddique St, Deira - Dubai"} location={location} />
      </div>
