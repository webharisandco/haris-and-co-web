    ...
    <div className="flex gap-5 md:gap-[30px] h-fit px-[16px] md:px-[80px] py-[50px] bg-white">
      <div className="lg:w-2/3 flex flex-col gap-5">
        ...
        <p className="font-[thin]">
         South India moves fast, and so does social media. This season, Shopsy wanted to make a splash and reach audiences in a way that felt fun, relatable, and impossible to ignore. That is where our influencer marketing team stepped in.
        </p>
        <p className="font-[thin]">
         The idea was clear. Connect with the right voices, create content people actually enjoy, and make Shopsy the topic of conversation across the region.
        </p>
        <p className="font-[thin]">
         We partnered with two influencers who each brought their own style and loyal followers. Together, they created two videos that captured the energy of South India while showcasing Shopsy in a playful and authentic way. These videos were designed to blend naturally into social feeds while grabbing attention and encouraging shares.
        </p>
        <p className="font-[thin]">
         The content highlighted Shopsy’s key features and benefits without feeling pushy. By paying attention to local trends, culture, and humour, we made sure the campaign felt both hyper-local and shareable.
        </p>
        ...
        >
          ...
          <h6 className="text-[22px] mt-5">The Results</h6>
          <p className="font-[thin]">
            • More than 10 million combined views across platforms
      <br />• High engagement through likes, comments, and shares
      <br />• Stronger brand awareness and recall in key South Indian markets

          </p>
          <p className="font-[thin]">
        The campaign succeeded because it felt like content people wanted to interact with, not a traditional ad. It created conversations, sparked engagement, and made Shopsy part of daily social media moments.
         </p>
          <p className="font-[thin]">
        This campaign shows the power of working with the right influencers and creating content that resonates. By understanding the audience and culture, Shopsy did not just reach people, it connected with them.
          </p>
          <p>
            <strong>Want your brand to make waves on social? Let’s make it happen.</strong>
          </p>
          {/* <h6 className="text-[22px] mt-5">The Results</h6>
          <p className="font-[thin]">
