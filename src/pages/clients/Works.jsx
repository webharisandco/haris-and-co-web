...
function Works() {
  return (
    <div className="bg-black">
      <div className="px-[17px] md:px-[40px] lg:px-[80px] mt-[40px] pb-[180px]">
        <div className=" grid grid-cols-1 lg:grid-cols-2 gap-y-[49px] md:gap-y-[100px] lg:gap-y-[150px] gap-x-[120px] mt-[40px] md:mt-[60px] lg:mt-[80px]">
          {OurWorksData.map((data) => (
            ...
            >
              ...
              <p className="font-medium text-white tracking-tighter text-[24px] md:text-[36px] text-left ml-[-11px]">
                {data.heading}
              </p>
              <p className="text-white font-[thin] opacity-55 text-left text-[16px] md:text-[24px]">
                {data.description}
              </p>
            </div>
          ))}
