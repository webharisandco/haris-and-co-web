    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10   py-[80px] bg-white'>
            ...
            <div className="font-[thin] flex flex-col gap-10 justify-between md:px-10">
                <div className='text-base md:text-[20px] 3xl:text-[24px] text-black/75 flex justify-between lg:justify-start gap-1'><span>{title} </span> <span className='hidden md:flex'> . </span> <span>{date}</span></div>
